      ...
      <div id="row">
        ...
        <p>
          <h2>What</h2>
            ...
            number of <strong>words</strong> and <strong>characters</strong> found
            in a text pasted into the textarea.
          </p>
        </div>
        <div className="column">
        <p>
          <h2>Why</h2>
            I wanted to practice using <strong>React Hooks</strong>. It is also a tribute to another site I've used
            during my whole time in Uni for counting characters/words in my exams and reports.
            <br /><br />Now I've got my own! Yey! {/* And I'm not in Uni anymore, also yey! */}
          </p>
        </div>
      </div>
    </div>
