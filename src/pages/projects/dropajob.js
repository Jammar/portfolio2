    ...
    <div className="content">
      <div id="row">
        <div className="column">
          ...
          <p>
            Styled-components was used for styling since there is a lot
            of fuss about it. Still not sure if Emotion.css is better though.
          </p>
        </div>
        <div className="column">
          <h2>Why</h2>
          ...
          <p>
            Fetch jobs from <a href="https://jobtechdev.se/en/docs/devguide/">
              JobTechDev API</a>, drag and
            drop them in the bin - relieve your stress!
          </p>
        </div>
      </div>
    </div>
